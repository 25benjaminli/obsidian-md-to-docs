...
On first run, a browser window will open to authorize access. The token is cached in `token.json` for subsequent runs.

After running, open the Google Doc and run the Auto-Latex Equations extension to render math.
